...
fn get_models_from_proto() -> HashMap<String, TikTokEventDataModel> {
    ...
    for item in syntax_tree.items {
        if let Item::Struct(struct_item) = item {
            ...
            let method_name_snake = camel_to_snake_case(enum_name.clone().as_str());
            ...
            let method_name_ident = Ident::new(&*method_name_snake, proc_macro2::Span::call_site());


            let method_name_token = quote! {
